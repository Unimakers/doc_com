...
<!------------TEST IMAGES PARCE QUE LA CA VA PAS, IDK WHY --- Chemins ? Peut-être? ----------------->

![Table de jeux CDR 2024](Projets_et_Réalisations/cdr/tablej.png)

<div style="display: flex;">
    <div style="flex: 1;">
        <img src="Projets_et_Réalisations/cdr/tablej.png" alt="Table de Jeux Coupe France de Robotique" style="max-width: 100%;">
    </div>
    <div style="flex: 1;">
        <!-- vidéo -->
    </div>
